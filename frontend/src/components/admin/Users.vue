...
import { adminUsers, adminUserCreate, adminUserUpdate, adminUserResetPassword } from '@/api'
...
async function createUser() {
  ...
  uForm.value = { username: '', password: '', display_name: '', role: 'user', tenant_id: activeTenantId.value || 1 }
  await loadUsers()
}
...
onMounted(loadUsers)
watch(activeTenantId, loadUsers)
</script>