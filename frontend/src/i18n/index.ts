...
const baseZh: Dict = {
  ...
  'tk.modeText': '文本',
  'tk.modeFile': '文件',
  'tk.fileHint': '点击选择文件：docx / xlsx / pptx / pdf / txt / csv（≤10MB）',
  'tk.langsLabel': '目标语言',
  'app.tabWorkbench': '翻译工作台',
  'app.tabTickets': '翻译工单',
  ...
  'tk.myTickets': '我的工单',
  'tk.colNo': '工单号', 'tk.run': '运行', 'tk.download': '下载', 'tk.detail': '进度',
...
const baseEn: Dict = {
  ...
  'chat.kbPackTip': 'Knowledge base packs applied to this account (dept>org>industry>locale)',
    'tk.entry': 'Translation Tickets',
  'tk.createTitle': 'Create Translation Ticket',
  'tk.modeText': 'Text',
  'tk.modeFile': 'File',
  'tk.fileHint': 'Click to select: docx / xlsx / pptx / pdf / txt / csv (≤10MB)',
  'tk.langsLabel': 'Target languages',
  'app.tabWorkbench': 'Workbench',
  'app.tabTickets': 'Tickets',
  'tk.titlePlaceholder': 'Ticket title (optional)',
  ...
  'tk.myTickets': 'My Tickets',
  'tk.colNo': 'No.', 'tk.run': 'Run', 'tk.download': 'Download', 'tk.detail': 'Progress',
  'tk.empty': 'No tickets yet', 'tk.defaultTitle': 'Untitled ticket',
