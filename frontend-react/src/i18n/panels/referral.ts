...
'referral.cfgTitle':'运营参数（仅超级管理员）',
  ...
  'referral.cfgRewardPoints': '受邀注册奖励积分（邀请人获得）',
  'referral.cfgPaidPoints': '首笔付费奖励积分（0 天=永久）',
...
'referral.cfgTitle':'Settings (super admin only)',
  ...
  'referral.cfgRewardPoints': 'Signup reward credits (to inviter)',
  'referral.cfgPaidPoints': 'First-paid reward credits (0 days = permanent)',
